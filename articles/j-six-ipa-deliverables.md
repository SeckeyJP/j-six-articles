...
:::message
本記事はシリーズ「**J-SIX：Japanese SI Transformation**」の番外編です。シリーズ全体の概要は [#0 概要編](https://zenn.dev/seckeyjp/articles/j-six-00-overview)、設計書を実装から逆生成する考え方は [#2 3層ドキュメント戦略](https://zenn.dev/seckeyjp/articles/j-six-02-3layer-doc) をご覧ください。
:::
...
想定読者は、顧客との合意形成を担う PM・PL・SE の方です。Claude Code（以下 CC）で設計書を逆生成する仕組みそのものは、[設計書逆生成の記事](https://zenn.dev/seckeyjp/articles/j-six-doc-reverse-gen)で解説しています。
