...
:::note
本記事はシリーズ「**J-SIX：Japanese SI Transformation**」の番外編です。シリーズ全体の概要は [#0 概要編](https://zenn.dev/seckeyjp/articles/j-six-00-overview)、Hook の基本は [CC Hooks 実践ガイド](https://zenn.dev/seckeyjp/articles/j-six-hooks-guide) をご覧ください。
:::
...
残りの2件は、J-SIX の品質ゲートの判定ロジックに関するものです。詳しくは [4層品質ゲートの記事](https://zenn.dev/seckeyjp/articles/j-six-quality-gates)で紹介しているので、要点だけ書きます。
