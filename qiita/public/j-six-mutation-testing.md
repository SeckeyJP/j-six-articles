...
CC に TDD でテストを書かせると、カバレッジは簡単に上がります。しかし [TDD × AI の10のアンチパターン](https://qiita.com/SeckeyJP/items/245988ce4fca5b2ba74a) で整理した通り、AI は「テストを通すこと」に最適化しがちで、アサーションの弱いテストでもカバレッジは上がります。
