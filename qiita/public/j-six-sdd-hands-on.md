...
:::note
本記事はシリーズ「**J-SIX：Japanese SI Transformation**」の番外編です。[#0 概要編](https://qiita.com/SeckeyJP/items/e4726bbbbf4d7949ab0f)で全体像を把握し、[#1 SDD](https://qiita.com/SeckeyJP/items/f23360f42ee385bd9213)で背景を理解した上でお読みください。
:::

## はじめに

[#1 の記事](https://qiita.com/SeckeyJP/items/f23360f42ee385bd9213)では「なぜ V 字モデルの前提が崩壊し、Spec-Driven Development（SDD）が台頭しているか」を解説した。理屈はわかったが、実際に手を動かすとなると「で、何から始めればいいの？」という疑問が残る。
...
CLAUDE.md は最初から完璧である必要はない。プロジェクトが進む中で CC と一緒に育てていけばよい。詳しくは [#4 CLAUDE.md 編](https://qiita.com/SeckeyJP/items/d267f1c523eb95b2c9b5)を参照。
...
タスクに依存関係がなければ、複数の CC セッションで並列に TDD を回せる。Agent Teams と git worktree を組み合わせることで、USER-001（登録）、USER-002（検索）、USER-003（更新）を同時に進行できる[^anthropic-teams]。詳しくは [Agent Teams 編](https://qiita.com/SeckeyJP/items/2639ae22b85e04a98c9c)を参照。
...
TDD との組み合わせについてさらに詳しく知りたい方は [#3 TDD × CC 編](https://qiita.com/SeckeyJP/items/a9dc743a14977686adbf)を、TDD 導入時のよくある失敗パターンについては [TDD アンチパターン編](https://qiita.com/SeckeyJP/items/245988ce4fca5b2ba74a)を参照してほしい。
