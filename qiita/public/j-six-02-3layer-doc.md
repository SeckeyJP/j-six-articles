...
なお J-SIX v2.1 では、この段階的対策をさらに具体化し、IPA の工程成果物27点の単位で「どの章を事前に出し、どの章を納品時に差し替えるか」を決める方式にしました。詳しくは[工程成果物27点で合意を分解する記事](https://qiita.com/SeckeyJP/items/9ca2e51f16189d62a5f6)をご覧ください。
