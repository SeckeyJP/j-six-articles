...
[TDD × AI の10のアンチパターン](https://qiita.com/SeckeyJP/items/245988ce4fca5b2ba74a)で取り上げたパターン④（トートロジカルテスト）やパターン⑤（カバレッジ詐称）を REVIEW.md で検出ルールとして定義することで、CC が生成するテストの品質を構造的にチェックできます。
...
[TDD × AI の10のアンチパターン](https://qiita.com/SeckeyJP/items/245988ce4fca5b2ba74a)では、パターン⑩として**自己レビューバイアス**を取り上げました。CC が書いたコードを同じ CC がレビューしても、生成時と同じバイアスがかかるため、問題を見逃しやすいという構造的な課題です。
...
[Agent Teams 実践ガイド](https://qiita.com/SeckeyJP/items/2639ae22b85e04a98c9c)で紹介した Writer/Reviewer パターンとの違いを整理します。
...
[CC Hooks 実践ガイド](https://qiita.com/SeckeyJP/items/b593f60a90a48a492c27)で解説した Hooks を活用し、PR 作成を検出して自動的にレビューをトリガーする構成も可能です。PostToolUse フックで `gh pr create` の実行を検出し、自動で `@claude review` コメントを投稿するスクリプトを組み合わせます。
...
[Agent Teams](https://qiita.com/SeckeyJP/items/2639ae22b85e04a98c9c) による実装中のリアルタイムレビューと、Code Review による PR 作成後の最終チェック。この二段構えが、AI 時代のコード品質を支える実践的な構成です。
