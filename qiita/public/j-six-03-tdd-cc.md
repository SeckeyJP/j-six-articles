...
順序は固定で、前段を通過したものだけが後段に進みます。4層の詳細は [J-SIX.md の Phase 4](https://github.com/SeckeyJP/j-six/blob/main/docs/J-SIX.md) で定義しています。G2 の mutation score については、カバレッジ 99% のコードで実測した記録を[番外編](https://zenn.dev/seckeyjp/articles/j-six-mutation-testing)にまとめています。4層それぞれの設計の理由と、実際に動かして見つかった問題は[4層品質ゲートの記事](https://zenn.dev/seckeyjp/articles/j-six-quality-gates)で解説しています。
